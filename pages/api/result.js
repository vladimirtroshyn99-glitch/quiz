...
— "suggested_questions" — 3 вопроса строго от ПЕРВОГО ЛИЦА: как будто пользователь прочитал разбор и хочет уточнить у ИИ-родолога. Правила:
  * Начинаются с "Я", "Мне", "У меня", "Почему я", "Как мне" — никогда не от второго лица
  * Цепляются за конкретный тезис или слово из summary, current_state или desired_state — не общие фразы
  * Звучат как живая, эмоциональная реакция человека, который только что увидел себя в зеркале
  * Первые 2 вопроса — про механику и осознание: "Почему я до сих пор...", "Как мне получить...", "Я понимаю, что..., но почему тогда..."
  * Третий вопрос — про конкретный первый практический шаг: "С чего мне начать прямо сейчас..."
  * ЗАПРЕЩЕНО формулировать от лица терапевта к клиенту ("Что бы сказала твоя мама...", "Как ты относишься к...")
...
Отвечай СТРОГО валидным JSON без markdown, без пояснений до/после:
{
  ...
  "suggested_questions": [
    "Я понимаю [конкретный вывод из разбора], но почему я всё равно продолжаю [паттерн]?",
    "Как мне [конкретное действие из разбора]? Что это значит на практике?",
