...
2. ГЕНЕРИРУЙ ТЕСТ из РОВНО 10 вопросов — не больше, не меньше. quiz_data ОБЯЗАН содержать ровно 10 объектов. Вопросы должны:
   ...
   Распредели 10 вопросов СТРОГО так:
   — 5 вопросов про ТЕКУЩУЮ СИТУАЦИЮ: что сейчас мешает, какие повторяющиеся паттерны, что удерживает, отношения с родителями, унаследованные убеждения
   — 5 вопросов про ЖЕЛАНИЯ И БУДУЩЕЕ: к чему стремишься, что для тебя важно, как выглядит идеальная картина, какие ресурсы уже есть, что бы ты сделала если бы не боялась
